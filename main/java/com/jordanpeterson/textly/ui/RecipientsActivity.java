...
import com.jordanpeterson.textly.adapters.UserAdapter;
import com.jordanpeterson.textly.utils.FileHelper;
...
//                    AlertDialog.Builder builder = new AlertDialog.Builder(RecipientsActivity.this);
//                    builder.setMessage(R.string.error_selecting_file).setTitle(R.string.error_sending_message).setPositiveButton(android.R.string.ok, null);
//                    AlertDialog dialog = builder.create();
//                    dialog.show();
                    finish();
                } else {
